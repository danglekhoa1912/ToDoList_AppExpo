...
import { SubText } from "../../../components/CustomText";
...
const Option = (props) => (
  ...
  >
    <Icon style={{ width: 20, height: 20 }} fill="#F96060" name={props.name} />
  </TouchableOpacity>
);
    ...
    <View style={{ ...styles.container, ...props.style }}>
      <FlatList
        ...
        data={TASK.sort(
          ...
          (task) => moment(task.date, "DD-MM-YYYY").diff(new Date(), "day") >= 0
        )}
